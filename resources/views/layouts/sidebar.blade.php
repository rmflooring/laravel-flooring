            ...
            <ul class="space-y-1 font-medium flex-1 overflow-y-auto min-h-0">
                ...
                <li>
                    <a href="{{ route('pages.messages.index') }}"
                       class="sidebar-link flex items-center gap-3 rounded-lg px-3 py-2 text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-200 dark:hover:bg-gray-800 {{ request()->routeIs('pages.messages.*') ? 'bg-gray-100 font-medium dark:bg-gray-800' : '' }}">
                        <svg class="h-5 w-5 flex-shrink-0 text-gray-500 dark:text-gray-400" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                        ...
                        <span id="sidebar-msg-badge" class="sidebar-label hidden rounded-full bg-blue-600 px-2 py-0.5 text-xs font-semibold text-white"></span>
                    </a>
                </li>

                {{-- Knowledge Assistant --}}
                <li>
                    <a href="{{ route('pages.knowledge-chat.index') }}"
                       class="sidebar-link flex items-center gap-3 rounded-lg px-3 py-2 text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-200 dark:hover:bg-gray-800 {{ request()->routeIs('pages.knowledge-chat.*') ? 'bg-gray-100 font-medium dark:bg-gray-800' : '' }}">
                        <svg class="h-5 w-5 flex-shrink-0 text-gray-500 dark:text-gray-400" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09ZM18.259 8.715 18 9.75l-.259-1.035a3.375 3.375 0 0 0-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 0 0 2.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 0 0 2.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 0 0-2.456 2.456Z"/>
                        </svg>
                        <span class="sidebar-label flex-1">Knowledge Assistant</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('pages.sms.index') }}"
                       class="sidebar-link flex items-center gap-3 rounded-lg px-3 py-2 text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-200 dark:hover:bg-gray-800 {{ request()->routeIs('pages.sms.*') ? 'bg-gray-100 font-medium dark:bg-gray-800' : '' }}">
                        <svg class="h-5 w-5 flex-shrink-0 text-gray-500 dark:text-gray-400" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z"/>
                        </svg>
                        <span class="sidebar-label flex-1">SMS Inbox</span>
                        <span id="sidebar-sms-badge" class="sidebar-label hidden rounded-full bg-blue-600 px-2 py-0.5 text-xs font-semibold text-white"></span>
                    </a>
                </li>
                ...
                <li x-data="{ open: {{ request()->routeIs('pages.sales.*') || request()->routeIs('pages.quick-sales.*') || request()->routeIs('pages.quick-returns.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open"
                        ...
                        <span class="sidebar-label flex-1">Sales</span>
                    ...
                    <ul x-show="open" x-cloak class="mt-1 ml-8 space-y-1">
                        <li>
                            <a href="{{ route('pages.sales.index') }}"
                               class="sidebar-link flex items-center gap-2 rounded-lg px-3 py-1.5 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-200 dark:hover:bg-gray-800 {{ request()->routeIs('pages.sales.*') ? 'bg-gray-100 font-medium dark:bg-gray-800' : '' }}">
                                All Sales
                            </a>
                        </li>
                        @can('create sales')
                ...
                @if (Route::has('admin.signing-requests.index'))
                <li>
                ...
                @if ($showAdminNav)
                    ...
                    {{-- Agent Tasks --}}
                    @if ($isAdminRole && Route::has('admin.agent.tasks.index'))
                        <li>
                            <a href="{{ route('admin.agent.tasks.index') }}"
                               class="sidebar-link flex items-center gap-3 rounded-lg px-3 py-2 text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-200 dark:hover:bg-gray-800 {{ request()->routeIs('admin.agent.tasks.*') ? 'bg-gray-100 font-medium dark:bg-gray-800' : '' }}">
                                <svg class="h-5 w-5 flex-shrink-0 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 0 1-2.555-.337A5.972 5.972 0 0 1 5.41 20.97a5.969 5.969 0 0 1-.474-.065 4.48 4.48 0 0 0 .978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25Z"/>
                                </svg>
                                <span class="sidebar-label">Agent Tasks</span>
                            </a>
                        </li>
                    @endif
                    ...
                    {{-- Reports --}}
                    @if ($canViewReports || $isAdminRole)
                        <li>
                            <a href="{{ route('admin.reports.index') }}"
                               class="sidebar-link flex items-center gap-3 rounded-lg px-3 py-2 text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-200 dark:hover:bg-gray-800 {{ request()->routeIs('admin.reports.*') ? 'bg-gray-100 font-medium dark:bg-gray-800' : '' }}">
                                <svg class="h-5 w-5 flex-shrink-0 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    ...
                    <li>
                        <a href="{{ route('admin.payments.index') }}"
                           class="sidebar-link flex items-center gap-3 rounded-lg px-3 py-2 text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-200 dark:hover:bg-gray-800 {{ request()->routeIs('admin.payments.*') ? 'bg-gray-100 font-medium dark:bg-gray-800' : '' }}">
                            <svg class="h-5 w-5 flex-shrink-0 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 0h.008v.008H6V10.5Z"/>
                            </svg>
                            <span class="sidebar-label">Payments Received</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('admin.audits.index') }}"
                           class="sidebar-link flex items-center gap-3 rounded-lg px-3 py-2 text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-200 dark:hover:bg-gray-800 {{ request()->routeIs('admin.audits.*') ? 'bg-gray-100 font-medium dark:bg-gray-800' : '' }}">
                            <svg class="h-5 w-5 flex-shrink-0 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    ...
                    {{-- Job Sources --}}
                    <li>
                        <a href="{{ route('admin.opportunity_sources.index') }}"
                           class="sidebar-link flex items-center gap-3 rounded-lg px-3 py-2 text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-200 dark:hover:bg-gray-800">
                            <svg class="h-5 w-5 flex-shrink-0 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.25 4.5l7.5 7.5-7.5 7.5m-6-15l7.5 7.5-7.5 7.5"/>
                            </svg>
                            <span class="sidebar-label">Job Sources</span>
                        </a>
                    </li>
        ...
        <header class="sticky top-0 z-30 border-b border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
            <div class="flex items-center justify-between px-4 py-3">
                ...
                <div class="relative flex items-center gap-3">
                    ...
                    <a id="nav-msg-icon" href="{{ route('pages.messages.index') }}"
                       class="relative text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                        <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12.76c0 1.6 1.123 2.994 2.707 3.227 1.068.157 2.148.279 3.238.364.466.037.893.281 1.153.671L12 21l2.652-3.978c.26-.39.687-.634 1.153-.671 1.09-.085 2.17-.207 3.238-.364 1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0 0 12 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018Z"/>
                        </svg>
                        <span id="nav-msg-badge"
                              class="absolute -right-1.5 -top-1.5 hidden min-w-[1.1rem] rounded-full bg-blue-600 px-1 py-0.5 text-center text-[10px] font-bold leading-none text-white"></span>
                    </a>
                ...
                <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                    ...
                    >
                        ...
                        <div id="user-avatar-btn" class="flex h-9 w-9 items-center justify-center rounded-full bg-gray-200 font-semibold text-gray-700 dark:bg-gray-700 dark:text-gray-200">
                ...
                </div>{{-- end messages+avatar wrapper --}}
