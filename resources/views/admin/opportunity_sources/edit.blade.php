            ...
            <div class="mb-6">
                <a href="{{ route('admin.opportunity_sources.index') }}"
                   class="text-sm text-blue-600 hover:underline dark:text-blue-400">
                    &larr; Back to Job Sources
                </a>
            </div>

            <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                <h1 class="text-xl font-bold text-gray-900 dark:text-white mb-6">Edit Source</h1>
                ...
                <form action="{{ route('admin.opportunity_sources.update', $source) }}" method="POST" class="space-y-5">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <label for="is_active" class="text-sm font-medium text-gray-700 dark:text-gray-300">
                            Active (available for opportunity assignments)
                        </label>
                    </div>
