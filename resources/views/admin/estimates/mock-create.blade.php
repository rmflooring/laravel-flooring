                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="estimate_number"
							    value=""
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="Auto-generated (YYYY-001)">
                            <p class="mt-1 text-xs text-gray-500">Mock value. Later this will auto-generate.</p>
                        </div>
    ...
    <input type="hidden" name="rooms[0][materials][0][line_total]" class="material-line-total-input" value="0">
            ...
            <div>
                ...
                <template class="freight-row-template">
                    <tr class="bg-white border-t">
                        <td class="px-3 py-2">
                            <input type="text" name="rooms[0][freight][0][freight_description]"
  ...
  <input type="hidden" name="rooms[0][freight][0][line_total]" class="freight-line-total-input" value="0">
            ...
            <div>
                ...
                <template class="labour-row-template">
                    <tr class="bg-white border-t">
                        <td class="px-3 py-2">
                            <input type="text" name="rooms[0][labour][0][labour_type]"
                                class="w-44 bg-gray-50 border border-gray-300 rounded-lg p-2"
                        ...
                        <td class="px-3 py-2">
                            <input type="text" name="rooms[0][labour][0][description]"
...
<div class="flex items-center justify-between border-b pb-2">
    <span class="text-sm text-gray-700">Tax (G)</span>
