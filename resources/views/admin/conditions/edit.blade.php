{{-- resources/views/admin/conditions/edit.blade.php --}}
<x-app-layout>
    <div class="max-w-screen-md mx-auto px-4 sm:px-6 lg:px-8 py-6">

        <div class="mb-6 flex items-center justify-between">
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Edit Condition</h1>
        ...
        <div class="rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <form method="POST" action="{{ route('admin.conditions.update', $condition->id) }}" class="p-6 space-y-4">
                @csrf
                @method('PUT')
