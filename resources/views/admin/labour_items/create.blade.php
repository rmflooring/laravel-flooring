                    ...
                    <form method="POST" action="{{ route('admin.labour_items.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="cost" value="{{ old('cost') }}" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" name="sell" id="sell" value="{{ old('sell') }}" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
