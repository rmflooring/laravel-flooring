        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="text-3xl font-bold mb-6">Add New Labour Item</h1>

                    <form method="POST" action="{{ route('admin.labour_items.store') }}">
                        @csrf

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Labour Type Dropdown (new field at the top) -->
                            <div class="md:col-span-2">
                                ...
                                <select name="labour_type_id" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    ...
                                    @foreach($labourTypes as $type)
                                        <option value="{{ $type->id }}" {{ old('labour_type_id') == $type->id ? 'selected' : '' }}>
                                            {{ $type->name }}  <!-- Change to $type->your_column if name is wrong -->
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" name="description" value="{{ old('description') }}" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div>
                                ...
                                <textarea name="notes" rows="3" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('notes') }}</textarea>
                            ...
                            <div>
                                ...
                                <input type="text" inputmode="decimal" name="cost" value="{{ old('cost') }}" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" onblur="if(this.value!==''&&!isNaN(parseFloat(this.value)))this.value=parseFloat(this.value).toFixed(2)">
                            ...
                            <div>
                                ...
                                <input type="text" inputmode="decimal" name="sell" id="sell" value="{{ old('sell') }}" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" onblur="if(this.value!==''&&!isNaN(parseFloat(this.value)))this.value=parseFloat(this.value).toFixed(2)">
                            ...
                            <div>
                                ...
                                <select name="status" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    ...
                                    <option value="Needs Update" {{ old('status') == 'Needs Update' ? 'selected' : '' }}>Needs Update</option>
                                </select>
