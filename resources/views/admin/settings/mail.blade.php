                    ...
                    <div class="border border-gray-200 dark:border-gray-600 rounded-lg overflow-hidden">
                        ...
                        <div class="divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                <div>
                                    <p class="text-sm font-medium text-gray-700 dark:text-gray-300">Sample Overdue Reminders</p>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Send email reminders to customers when showroom samples are overdue for return.</p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="sample_email_reminders_enabled" value="1" class="sr-only peer"
                                           {{ $sampleEmailReminders ? 'checked' : '' }}>
                                    <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                                </label>
                            </div>
                        </div>
