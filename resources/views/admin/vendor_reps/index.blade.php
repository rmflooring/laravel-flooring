            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-4 text-gray-900">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('admin.vendor_reps.create') }}"
                    ...
                    @include('admin.partials.filter-bar', [
                        'action' => route('admin.vendor_reps.index'),
                                ...
                                @forelse($reps as $rep)
                                    <tr class="bg-white border-b hover:bg-gray-50">
                                        <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">
                                            <a href="{{ route('admin.vendor_reps.show', $rep) }}" class="text-indigo-600 hover:underline">{{ $rep->name }}</a>
                                        </td>
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            @if($rep->email)
                                                <a href="mailto:{{ $rep->email }}" class="text-indigo-600 hover:underline">{{ $rep->email }}</a>
                                            @else
                                                -
                                            @endif
                                        </td>
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap">
                                            <a href="{{ route('admin.vendor_reps.edit', $rep) }}"
                                ...
                                @empty
                                    <tr class="bg-white border-b">
                                        <td colspan="5" class="px-6 py-8 text-center text-gray-500">
                                            No vendor reps found.
                                            <a href="{{ route('admin.vendor_reps.create') }}" class="text-blue-600 hover:underline">
                                                Add the first one
                                            </a>.
                                        </td>
                                    </tr>
