        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-start justify-between gap-4 mb-6">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Create a new employee record.</p>
                </div>
            ...
            <form method="POST" action="{{ route('admin.employees.store') }}"
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                        ...
                        <div>
                            ...
                            <select name="employee_role_id"
                                ...
                                @foreach ($roles as $role)
                                    <option value="{{ $role->id }}" @selected((string)old('employee_role_id') === (string)$role->id)>
                                        {{ $role->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="role_other" value="{{ old('role_other') }}"
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 mb-4">
                        SIN is stored encrypted. Only authorized users should be allowed to view/reveal it.
                    </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">
                                We store the full SIN encrypted + last 4 digits for masking.
                            </p>
                        </div>
                    </div>
                </div>
