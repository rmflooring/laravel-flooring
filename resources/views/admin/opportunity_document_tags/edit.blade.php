            ...
            <div class="mb-6">
                <a href="{{ route('admin.opportunity_document_tags.index') }}"
                   class="text-sm text-blue-600 hover:underline dark:text-blue-400">
                    &larr; Back to Document Tags
                </a>
            </div>

            <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                <h1 class="text-xl font-bold text-gray-900 dark:text-white mb-6">Edit Tag</h1>
                ...
                <form action="{{ route('admin.opportunity_document_tags.update', $tag) }}" method="POST" class="space-y-5">
                    @csrf
                    @method('PUT')
