            ...
            <div class="rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 gap-6 lg:grid-cols-12">
                        ...
                        <div class="lg:col-span-12">
                            <div class="rounded-lg border border-gray-200 bg-gray-50 p-5 dark:border-gray-700 dark:bg-gray-900/30">
                                <p class="mb-3 text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">Insurance Details</p>
...
<td class="px-6 py-4">
    ...
    @endif
            ...
            <div class="mt-6 rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <div class="p-6">
                    <div class="flex flex-wrap gap-3">
                        ...
                        {{-- New Message Thread --}}
                        <a href="{{ route('pages.messages.index', ['new' => 1, 'threadable_type' => 'opportunity', 'threadable_id' => $opportunity->id]) }}"
                           class="inline-flex items-center gap-2 rounded-lg border border-indigo-300 bg-indigo-50 px-4 py-2 text-sm font-medium text-indigo-700 hover:bg-indigo-100 focus:outline-none focus:ring-4 focus:ring-indigo-200">
            ...
            <div class="mt-6 rounded-lg border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <div class="border-b border-gray-200 p-6 dark:border-gray-700">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Notes &amp; Updates</h2>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">Internal notes visible to all staff.</p>
                </div>
                    ...
                    <form method="POST" action="{{ route('pages.opportunities.notes.store', $opportunity) }}">
                        ...
                        <div>
                            <textarea name="body" rows="3"
                                      ...
                                      class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-3 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500"
                        ...
                        <div class="space-y-4">
                            @foreach($opportunity->notes as $note)
                                <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900/30"
                                     x-data="{ editing: false, body: {{ json_encode($note->body) }} }">
                                    ...
                                    <div class="mb-2 flex items-center justify-between gap-2">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-xs text-gray-400 dark:text-gray-500">
                                                ...
                                                @if($note->updated_at->gt($note->created_at->addMinute()))
                                                    <span class="italic">(edited {{ $note->updated_at->format('M j, Y g:i A') }})</span>
                                                @endif
                                            </span>
                                        </div>
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            @if(auth()->id() === $note->user_id || auth()->user()->hasRole('admin'))
                                                <form method="POST"
                                                      action="{{ route('pages.opportunities.notes.destroy', [$opportunity, $note]) }}"
                                    ...
                                    {{-- Edit form --}}
                                    <form method="POST"
                                          action="{{ route('pages.opportunities.notes.update', [$opportunity, $note]) }}"
                                          x-show="editing"
                                          x-cloak>
                                        @csrf
                                        @method('PATCH')
                                        <textarea name="body" rows="3" x-model="body"
                                                  class="block w-full rounded-lg border border-gray-300 bg-white p-3 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-800 dark:text-white"></textarea>
                                        <div class="mt-2 flex justify-end gap-2">
                                            <button type="button" @click="editing = false"
                                                    class="rounded-lg border border-gray-300 bg-white px-3 py-1.5 text-xs font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200">
                                                Cancel
                                            </button>
                                            <button type="submit"
                                                    class="rounded-lg bg-blue-700 px-3 py-1.5 text-xs font-medium text-white hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700">
                                                Save
                                            </button>
                                        </div>
                                    </form>
