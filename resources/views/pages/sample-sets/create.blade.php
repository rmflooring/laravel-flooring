    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('pages.samples.index') }}" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18"/>
                    </svg>
                </a>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">New Sample Set</h1>
            </div>
            ...
            <form action="{{ route('pages.sample-sets.store') }}" method="POST"
                  x-data="sampleSetCreate()"
                ...
                <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm p-6 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Set Name <span class="text-xs text-gray-400">(optional)</span></label>
                            <input type="text" name="name" value="{{ old('name') }}"
                                   placeholder="e.g. Shaw Summer 2024 Binder"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:text-white dark:border-gray-600">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Location <span class="text-xs text-gray-400">(optional)</span></label>
                            <input type="text" name="location" value="{{ old('location') }}"
                                   placeholder="e.g. Showroom Rack B"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:text-white dark:border-gray-600">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="notes" rows="2"
                                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:text-white dark:border-gray-600">{{ old('notes') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm p-6 space-y-4 mt-4">
                    ...
                    <div x-show="!selectedLineId" class="py-8 text-center text-gray-400 dark:text-gray-500 text-sm">
                        Select a product line above to see available styles.
                    </div>

                    <div x-show="selectedLineId && loading" class="py-8 text-center text-gray-400 text-sm">
                        Loading styles…
                    </div>

                    <div x-show="selectedLineId && !loading && styles.length === 0" class="py-8 text-center text-gray-400 text-sm">
                        No active styles found for this product line.
                    </div>
                                ...
                                <div class="text-right">
                                    ...
                                    <div class="flex items-center gap-1">
                                        ...
                                        <input type="number" step="0.01" min="0"
                                               ...
                                               :placeholder="style.sell_price ? style.sell_price.toFixed(2) : ''"
                                               @click.stop
                    ...
                    {{-- Hidden inputs for selected style IDs --}}
                    {{-- Already handled by checkboxes with name="style_ids[]" --}}
