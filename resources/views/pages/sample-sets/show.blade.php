                ...
                <div class="flex items-center gap-2 flex-wrap">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.outside="open = false" x-cloak
                            ...
                            <a href="{{ route('pages.sample-sets.label', [$sampleSet, 'format' => '5371', 'show_price' => '0']) }}" target="_blank"
                            ...
                            <a href="{{ route('pages.sample-sets.label', [$sampleSet, 'format' => '5388', 'show_price' => '0']) }}" target="_blank"
                               class="block px-4 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 border-t border-gray-100 dark:border-gray-700">
                                Avery 5388 — no price
                            </a>
                            ...
                            <a href="{{ route('pages.sample-sets.label', [$sampleSet, 'format' => 'ql700', 'show_price' => '0']) }}" target="_blank"
