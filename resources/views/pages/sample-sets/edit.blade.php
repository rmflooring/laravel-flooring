<x-app-layout>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            @php
            $currentLine = $productLines->firstWhere('id', $sampleSet->product_line_id);
            $currentLineLabel = $currentLine
                ? ($currentLine->manufacturer ? $currentLine->manufacturer . ' — ' . $currentLine->name : $currentLine->name)
                : '';
        @endphp
        Alpine.data('sampleSetEdit', () => ({
                ...
                lineSearch: @json($currentLineLabel),
