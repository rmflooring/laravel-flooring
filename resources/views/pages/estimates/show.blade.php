        ...
        <form method="POST" action="{{ route('pages.estimates.send-email', $estimate) }}">
            ...
            <div class="px-6 py-5 space-y-4 max-h-[70vh] overflow-y-auto">
                ...
                <div class="flex items-center gap-2 py-1">
                    <input type="checkbox" name="request_read_receipt" id="rr_estimate" value="1"
                           class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                    <label for="rr_estimate" class="text-sm text-gray-600 dark:text-gray-400 cursor-pointer">
