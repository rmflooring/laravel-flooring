                    ...
                    <div class="md:col-span-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="search" value="{{ $filters['search'] ?? '' }}"
                                   placeholder="Sample ID, product name, SKU, colour..."
                    ...
                    <table class="w-full text-sm text-left text-gray-700 dark:text-gray-300">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 border-b border-gray-200 dark:bg-gray-700 dark:text-gray-400 dark:border-gray-600">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-right">Price / Unit</th>
                        ...
                        <tbody>
                            @forelse ($samples as $sample)
                                ...
                                <tr class="bg-white dark:bg-gray-800 border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-6 py-4 text-center text-gray-700 dark:text-gray-300">{{ $sample->quantity }}</td>
                                    <td class="px-6 py-4 text-center">
                                        @php $avail = $sample->available_qty; @endphp
                                        <span class="font-semibold {{ $avail === 0 ? 'text-red-600' : 'text-green-700 dark:text-green-400' }}">
                                            {{ $avail }}
                                        </span>
                                    </td>
