        ...
        <div class="lg:grid lg:grid-cols-5 lg:gap-8 lg:items-start">
            ...
            <div class="lg:col-span-3">
                <div class="mb-2 flex items-center justify-between">
                    <span class="text-xs font-semibold uppercase tracking-wide text-gray-400">Document Preview</span>
                    <a href="{{ route('sign.document', $signingRequest->uuid) }}"
                       target="_blank"
                ...
                {{-- Mobile-only scroll CTA — guides user to signature section --}}
                <button type="button"
                        onclick="document.getElementById('sign-section').scrollIntoView({ behavior: 'smooth', block: 'start' })"
                        class="mt-4 w-full rounded-lg bg-blue-50 border border-blue-200 px-4 py-3 text-sm font-semibold text-blue-700 hover:bg-blue-100 active:bg-blue-200 lg:hidden">
                    Done reviewing &mdash; continue to sign ↓
                </button>
            </div>

            {{-- Signature column (2/5, sticky on desktop) --}}
            <div class="mt-8 lg:mt-0 lg:col-span-2 lg:sticky lg:top-6" id="sign-section">
