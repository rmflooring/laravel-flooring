...
class QuickBooksController extends Controller
{
    ...
    public function index()
    {
        ...
        $settings = [
            ...
            'qbo_ap_gst_pst_code_id'       => Setting::get('qbo_ap_gst_pst_code_id', ''),
    ...
    public function saveSettings(Request $request)
    {
        $request->validate([
            ...
            'qbo_ap_gst_pst_code_id'      => 'nullable|string|max:50',
        ...
        Setting::set('qbo_ap_gst_pst_code_id',      trim($request->qbo_ap_gst_pst_code_id ?? ''));
