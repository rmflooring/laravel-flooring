...
class GraphMailService
{
    ...
    public function send(
        ...
        try {
            ...
            if ($icsContent) {
                // Use raw MIME so Exchange processes this as a meeting request
    ...
    /**
     * Build a raw RFC 2822 MIME message where the ICS is an inline
     * text/calendar part. Exchange/Outlook renders Accept / Decline buttons
     * when the calendar part is inline — a fileAttachment never triggers this.
     */
    private function buildMimeWithCalendar(
        ...
        $mime .= "\r\n";
        $mime .= chunk_split(base64_encode($body), 76, "\r\n");

        // Inline calendar part — what makes Accept/Decline appear
        $mime .= "--{$boundary}\r\n";
        $mime .= "Content-Type: text/calendar; method=REQUEST; charset=UTF-8\r\n";
        $mime .= "Content-Transfer-Encoding: base64\r\n";
