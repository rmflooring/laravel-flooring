...
class DocumentTemplateService
{
    ...
    public function render(DocumentTemplate $template, Opportunity $opportunity, ?Sale $sale = null): string
    {
        ...
        return $this->renderFromFields($template, $fields, $sale);
    }
     ...
     * flooring_items_table is always rebuilt fresh from sale data.
     */
    public function renderFromFields(DocumentTemplate $template, array $fields, ?Sale $sale = null): string
    {
        $body = $template->body;
