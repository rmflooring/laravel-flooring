...
<div style="font-size:12px; line-height:1.5; color:#111;">
  ...
  <!-- Job # card with QR -->
  <div style="border:2px solid #111; border-radius:4px 4px 0 0; padding:10px 16px; background:#fff;">
    <table style="width:100%; border-collapse:collapse;">
      <tr>
        <td style="vertical-align:middle;">
          <div style="font-size:24px; font-weight:700; letter-spacing:0.5px; color:#111;">Job #{{job_no}}</div>
          <div style="font-size:14px; margin-top:3px; color:#111; font-weight:500;">{{customer_name}}</div>
        </td>
  ...
  <!-- Job name strip -->
  <div style="border:1px solid #d1d5db; border-top:none; border-radius:0 0 4px 4px; padding:6px 16px; font-size:12px; color:#374151; font-weight:600; margin-bottom:14px;">
    {{job_name}}
  </div>
  ...
  <div style="margin-top:12px; border:1px solid #fde68a; background:#fffbeb; border-radius:4px; padding:10px 12px; min-height:50px;">
    ...
    <div style="white-space:pre-wrap; font-size:12px; color:#111;">{{special_instructions}}</div>
  </div>
  ...
  <div style="margin-top:12px; border:1px solid #e5e7eb; border-radius:4px; padding:10px 12px; min-height:70px;">
    ...
    <div style="white-space:pre-wrap; font-size:12px; color:#111;">{{notes}}</div>
  </div>
